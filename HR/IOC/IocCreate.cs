...
namespace IOC
{
    public class IocCreate
    {
        ...
        private static UnityContainer GetBLLSeciton()
        {
            ...
            ecf.ExeConfigFilename = @"C:\Users\lenovo\Source\Repos\HR\HR\UI\Unity.config";
        ...
        #region 用户身份
        public static IGuanliDAO CreateGuanliDAO()
        {
            UnityContainer ioc = new UnityContainer();
            ioc.RegisterType<IGuanliDAO, GuanliDAO>();
            return ioc.Resolve<IGuanliDAO>();
        }

        public static IGuanliBLL CreateGuanliBLL()
        {
            UnityContainer ioc = GetBLLSeciton();
            return ioc.Resolve<IGuanliBLL>("GuanliBLL");
        }
        #endregion
