...
namespace DAO
{
    public class %tableName%DAO:DaoBase<%tableName%>,I%tableName%DAO
    {
...
namespace IOC
{
        public static I%tableName%DAO Create%tableName%DAO()
        {
            UnityContainer ioc = new UnityContainer();
            ioc.RegisterType<I%tableName%DAO, %tableName%DAO>();
            return ioc.Resolve<I%tableName%DAO>();
        }
...
namespace BLL
{
    ...
    {
      I%tableName%DAO ist = IocCreate.Create%tableName%DAO();
...
namespace Model
{
    ...
    {");
        ...
        public %type% %name% { get;set; }");
                ...
                using (StreamWriter sw = new StreamWriter("DAO\\" + tableName + "DAO.cs"))
                {
                    sw.WriteLine(dal);
                }
                using (StreamWriter sw = new StreamWriter("IntDAO\\I" + tableName + "DAO.cs"))
                {
                    sw.WriteLine(idal);
                }
                ...
                using (StreamWriter sw = new StreamWriter("IntBLL\\I" + tableName + "BLL.cs"))
                {
                    sw.WriteLine(ibll);
                }
            }
